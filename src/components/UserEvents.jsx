...
export const UserEvents = async ({ events }) => {
  return (
    <div className="h-16 flex gap-3 items-center">
      ...
      <div className="flex flex-col grow flex-1 min-w-0">
        <h2 className="font-semibold min-w-0 truncate">{events.title}</h2>
      ...
      <div className="flex gap-2">
        <Link href={`/${events.id}`}>
          <button
            className="button btn-success w-full p-2"
            title="Detail Event"
          >
...
export function PhPencilSimpleFill(props) {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="m227.31 73.37l-44.68-44.69a16 16 0 0 0-22.63 0L36.69 152A15.86 15.86 0 0 0 32 163.31V208a16 16 0 0 0 16 16h44.69a15.86 15.86 0 0 0 11.31-4.69L227.31 96a16 16 0 0 0 0-22.63M192 108.68L147.31 64l24-24L216 84.68Z"
      ></path>
    </svg>
  );
}
